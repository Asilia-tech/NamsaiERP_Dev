...
class LocalString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "en_US": {
          ...
          "chooseclassdivision":
              "Please choose class and division to get student list",
          ...
          "logtime": "Log My Time",
          "logtimealert":
              "Set Automatic time zone setting enable to do clocking",
          "attendancedate": "Choose attendance date",
          "locationalert":
              "Location services are currently turned off. Please refresh to enable them.",
          "promotealert": "You can't promote student to next class",
          "futuredate":
              "You are not allowed to request sick leave for a date in the future.",
          "workdayrequired":
              "Your requested time off must include at least one workday. Please change the dates you've entered accordingly.",
          "gm": "Good Morning",
          "ga": "Good Afternoon",
          "ge": "Good Evening",
          "title": "Title",
          ...
          "residentaddresstf": "Enter resident address",
          "subcaste": "Sub-caste",
          "caste": "Caste",
